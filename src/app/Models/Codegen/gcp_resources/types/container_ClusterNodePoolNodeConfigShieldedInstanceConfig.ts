...
export interface container_ClusterNodePoolNodeConfigShieldedInstanceConfig {
  /*
...
export function container_ClusterNodePoolNodeConfigShieldedInstanceConfig_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Bool,
