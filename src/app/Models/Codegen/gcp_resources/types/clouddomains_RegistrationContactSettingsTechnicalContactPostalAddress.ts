...
export interface clouddomains_RegistrationContactSettingsTechnicalContactPostalAddress {
  /*
...
export function clouddomains_RegistrationContactSettingsTechnicalContactPostalAddress_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "postalCode",
