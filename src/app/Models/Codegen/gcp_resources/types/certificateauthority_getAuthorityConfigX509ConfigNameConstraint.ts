...
export interface certificateauthority_getAuthorityConfigX509ConfigNameConstraint {
  /*
...
export function certificateauthority_getAuthorityConfigX509ConfigNameConstraint_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "permittedDnsNames",
