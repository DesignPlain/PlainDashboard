...
export interface compute_RegionUrlMapDefaultRouteActionCorsPolicy {
...
export function compute_RegionUrlMapDefaultRouteActionCorsPolicy_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Bool,
      "disabled",
