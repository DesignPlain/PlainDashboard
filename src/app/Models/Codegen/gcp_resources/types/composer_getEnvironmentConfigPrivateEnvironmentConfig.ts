...
export interface composer_getEnvironmentConfigPrivateEnvironmentConfig {
...
export function composer_getEnvironmentConfigPrivateEnvironmentConfig_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "masterIpv4CidrBlock",
