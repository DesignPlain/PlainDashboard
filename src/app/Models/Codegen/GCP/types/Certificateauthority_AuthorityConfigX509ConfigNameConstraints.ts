...
export interface certificateauthority_AuthorityConfigX509ConfigNameConstraints {
  /*
...
export function certificateauthority_AuthorityConfigX509ConfigNameConstraints_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "excludedIpRanges",
