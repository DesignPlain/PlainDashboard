...
import {
  Compute_RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout,
  Compute_RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout_GetTypes,
} from "./Compute_RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout";

export interface Compute_RegionUrlMapDefaultRouteActionRetryPolicy {
...
*/
  PerTryTimeout?: Compute_RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout;
...
export function Compute_RegionUrlMapDefaultRouteActionRetryPolicy_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Number,
      "NumRetries",
