...
export interface monitoring_AlertPolicyConditionConditionThresholdAggregation {
  /*
...
export function monitoring_AlertPolicyConditionConditionThresholdAggregation_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "alignmentPeriod",
