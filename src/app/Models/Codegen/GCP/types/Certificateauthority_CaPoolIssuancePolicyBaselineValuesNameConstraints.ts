...
export interface certificateauthority_CaPoolIssuancePolicyBaselineValuesNameConstraints {
  /*
...
export function certificateauthority_CaPoolIssuancePolicyBaselineValuesNameConstraints_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "excludedIpRanges",
