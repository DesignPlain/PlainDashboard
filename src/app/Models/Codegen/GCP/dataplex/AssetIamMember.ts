...
import { AssetIAMMemberCondition } from "../types/AssetIAMMemberCondition";
...
*/
  ...
  //
  Condition?: AssetIAMMemberCondition;
...
export class AssetIAMMember extends Resource {
  // Used to find the parent resource to bind the IAM policy to
  public Asset?: string;
...
*/
  ...
  //
  public Condition?: AssetIAMMemberCondition;
...
*/
  ...
  public static GetTypes(): DynamicUIProps[] {
    return [
      ...
      new DynamicUIProps(InputType.String, "DataplexZone", ""),
      new DynamicUIProps(InputType.String, "Lake", ""),
