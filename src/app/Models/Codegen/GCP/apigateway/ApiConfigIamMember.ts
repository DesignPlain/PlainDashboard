...
import { ApiConfigIAMMemberCondition } from "../types/ApiConfigIAMMemberCondition";
...
export interface ApiConfigIAMMemberArgs {
  ...
  //
  Condition?: ApiConfigIAMMemberCondition;
...
export class ApiConfigIAMMember extends Resource {
  /*
The API to attach the config to.
Used to find the parent resource to bind the IAM policy to
*/
  ...
  //
  public Condition?: ApiConfigIAMMemberCondition;
...
*/
  ...
  public static GetTypes(): DynamicUIProps[] {
    return [
      ...
      new DynamicUIProps(InputType.String, "ApiConfig", ""),
    ];
  }
}
