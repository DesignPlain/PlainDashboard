...
import { FeatureIAMBindingCondition } from "../types/FeatureIAMBindingCondition";

export interface FeatureIAMBindingArgs {
  //
  Condition?: FeatureIAMBindingCondition;
...
export class FeatureIAMBinding extends Resource {
  //
  public Condition?: FeatureIAMBindingCondition;
