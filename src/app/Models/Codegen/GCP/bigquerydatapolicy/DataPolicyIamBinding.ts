...
import { DataPolicyIAMBindingCondition } from "../types/DataPolicyIAMBindingCondition";
...
export class DataPolicyIAMBinding extends Resource {
  //
  public Condition?: DataPolicyIAMBindingCondition;
...
*/
  ...
  public static GetTypes(): DynamicUIProps[] {
    return [
      ...
      new DynamicUIProps(InputType.String, "DataPolicyId", ""),
      new DynamicUIProps(
        InputType.String,
        "Location",
        "The name of the location of the data policy.\nUsed to find the parent resource to bind the IAM policy to",
