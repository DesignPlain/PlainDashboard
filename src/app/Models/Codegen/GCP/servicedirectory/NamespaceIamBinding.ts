...
import { NamespaceIAMBindingCondition } from "../types/NamespaceIAMBindingCondition";

export interface NamespaceIAMBindingArgs {
  //
  Condition?: NamespaceIAMBindingCondition;
...
export class NamespaceIAMBinding extends Resource {
  //
  public Condition?: NamespaceIAMBindingCondition;
