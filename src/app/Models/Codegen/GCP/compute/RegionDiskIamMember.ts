...
import { RegionDiskIAMMemberCondition } from "../types/RegionDiskIAMMemberCondition";

export interface RegionDiskIAMMemberArgs {
  //
  Condition?: RegionDiskIAMMemberCondition;
...
*/
  ...
  //
  public Condition?: RegionDiskIAMMemberCondition;
