...
import { AutoscalingPolicyIAMBindingCondition } from "../types/AutoscalingPolicyIAMBindingCondition";

export interface AutoscalingPolicyIAMBindingArgs {
  //
  Condition?: AutoscalingPolicyIAMBindingCondition;
...
export class AutoscalingPolicyIAMBinding extends Resource {
  //
  public Condition?: AutoscalingPolicyIAMBindingCondition;
