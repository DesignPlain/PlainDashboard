...
import { PolicyTagIAMMemberCondition } from "../types/PolicyTagIAMMemberCondition";

export interface PolicyTagIAMMemberArgs {
  //
  Condition?: PolicyTagIAMMemberCondition;
...
export class PolicyTagIAMMember extends Resource {
  //
  public Condition?: PolicyTagIAMMemberCondition;
