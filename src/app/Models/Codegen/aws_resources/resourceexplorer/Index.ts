...
import {
  resourceexplorer_IndexTimeouts,
  resourceexplorer_IndexTimeouts_GetTypes,
} from "../types/resourceexplorer_IndexTimeouts";

export interface IndexArgs {
  //
  timeouts?: resourceexplorer_IndexTimeouts;
...
export class Index extends Resource {
  ...
  //
  public timeouts?: resourceexplorer_IndexTimeouts;
