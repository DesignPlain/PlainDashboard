...
export interface lex_V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValue {
...
export function lex_V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValue_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "interpretedValue",
