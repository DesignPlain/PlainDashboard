...
export interface opsworks_HaproxyLayerLoadBasedAutoScalingDownscaling {
  //
...
export function opsworks_HaproxyLayerLoadBasedAutoScalingDownscaling_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "alarms",
