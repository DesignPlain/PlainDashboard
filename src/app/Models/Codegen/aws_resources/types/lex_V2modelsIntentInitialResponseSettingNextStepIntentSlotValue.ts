...
export interface lex_V2modelsIntentInitialResponseSettingNextStepIntentSlotValue {
...
export function lex_V2modelsIntentInitialResponseSettingNextStepIntentSlotValue_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "interpretedValue",
