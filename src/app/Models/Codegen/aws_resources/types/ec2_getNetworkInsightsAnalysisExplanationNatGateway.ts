...
export interface ec2_getNetworkInsightsAnalysisExplanationNatGateway {
...
export function ec2_getNetworkInsightsAnalysisExplanationNatGateway_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
