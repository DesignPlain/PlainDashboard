...
import {
  wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern,
  wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern_GetTypes,
...
export interface wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies {
  ...
  matchPatterns?: Array<wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern>;
...
export function wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "matchPatterns",
