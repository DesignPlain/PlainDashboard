...
export interface emr_ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification {
...
export function emr_ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "allocationStrategy",
