...
export interface lex_V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValue {
...
export function lex_V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValue_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "interpretedValue",
