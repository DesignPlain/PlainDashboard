...
export interface ec2_getNetworkInsightsAnalysisForwardPathComponentVpc {
  //
  id?: string;
...
export function ec2_getNetworkInsightsAnalysisForwardPathComponentVpc_GetTypes(): DynamicUIProps[] {
  return [
