...
import {
  wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern,
...
export interface wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody {
  ...
  matchPattern?: wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern;
...
export function wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "oversizeHandling",
