...
export interface ec2_getNetworkInsightsAnalysisExplanationCustomerGateway {
...
export function ec2_getNetworkInsightsAnalysisExplanationCustomerGateway_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
