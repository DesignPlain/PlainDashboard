...
import {
  wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern,
...
export interface wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchCookies {
  ...
  matchPatterns?: Array<wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern>;
...
export function wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchCookies_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "matchPatterns",
