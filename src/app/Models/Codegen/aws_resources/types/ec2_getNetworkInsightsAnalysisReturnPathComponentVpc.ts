...
export interface ec2_getNetworkInsightsAnalysisReturnPathComponentVpc {
...
export function ec2_getNetworkInsightsAnalysisReturnPathComponentVpc_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
