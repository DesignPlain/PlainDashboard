...
export interface ec2_getNetworkInsightsAnalysisExplanationVpnGateway {
...
export function ec2_getNetworkInsightsAnalysisExplanationVpnGateway_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
