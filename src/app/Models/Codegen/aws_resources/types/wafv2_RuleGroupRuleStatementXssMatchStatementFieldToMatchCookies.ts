...
import {
  wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern,
...
export interface wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies {
  ...
  matchPatterns?: Array<wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern>;
}

export function wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "matchScope",
