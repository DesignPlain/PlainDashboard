...
export interface lex_V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction {
...
export function lex_V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "type",
