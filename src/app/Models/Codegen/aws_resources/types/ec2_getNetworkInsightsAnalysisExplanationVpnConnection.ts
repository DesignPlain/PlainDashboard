...
export interface ec2_getNetworkInsightsAnalysisExplanationVpnConnection {
  //
  id?: string;
...
export function ec2_getNetworkInsightsAnalysisExplanationVpnConnection_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
