...
export interface lex_V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction {
...
export function lex_V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "slotToElicit",
