...
export interface opsworks_MysqlLayerLoadBasedAutoScalingUpscaling {
  //
...
export function opsworks_MysqlLayerLoadBasedAutoScalingUpscaling_GetTypes(): DynamicUIProps[] {
  return [
