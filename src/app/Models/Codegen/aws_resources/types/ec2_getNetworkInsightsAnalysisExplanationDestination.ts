...
export interface ec2_getNetworkInsightsAnalysisExplanationDestination {
...
export function ec2_getNetworkInsightsAnalysisExplanationDestination_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
