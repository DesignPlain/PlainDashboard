...
export interface lex_V2modelsIntentClosingSettingConditionalConditionalBranchNextStepIntentSlotValue {
...
export function lex_V2modelsIntentClosingSettingConditionalConditionalBranchNextStepIntentSlotValue_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "interpretedValue",
