...
export interface kinesis_FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig {
...
export function kinesis_FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "roleArn",
