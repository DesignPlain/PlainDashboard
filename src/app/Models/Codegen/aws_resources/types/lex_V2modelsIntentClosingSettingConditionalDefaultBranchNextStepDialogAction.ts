...
export interface lex_V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction {
...
export function lex_V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "slotToElicit",
