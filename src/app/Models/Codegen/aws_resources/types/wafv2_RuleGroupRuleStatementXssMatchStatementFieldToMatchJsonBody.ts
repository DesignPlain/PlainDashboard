...
import {
  wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern,
  wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern_GetTypes,
...
export interface wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody {
  ...
  matchPattern?: wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern;
...
export function wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
