...
export interface opsworks_PhpAppLayerLoadBasedAutoScalingDownscaling {
  //
...
export function opsworks_PhpAppLayerLoadBasedAutoScalingDownscaling_GetTypes(): DynamicUIProps[] {
  return [
