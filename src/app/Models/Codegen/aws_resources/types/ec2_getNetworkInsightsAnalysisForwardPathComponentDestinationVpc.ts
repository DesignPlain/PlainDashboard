...
export interface ec2_getNetworkInsightsAnalysisForwardPathComponentDestinationVpc {
...
export function ec2_getNetworkInsightsAnalysisForwardPathComponentDestinationVpc_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
