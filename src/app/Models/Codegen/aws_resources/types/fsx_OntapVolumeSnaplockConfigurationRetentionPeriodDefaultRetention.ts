...
export interface fsx_OntapVolumeSnaplockConfigurationRetentionPeriodDefaultRetention {
...
export function fsx_OntapVolumeSnaplockConfigurationRetentionPeriodDefaultRetention_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "type",
