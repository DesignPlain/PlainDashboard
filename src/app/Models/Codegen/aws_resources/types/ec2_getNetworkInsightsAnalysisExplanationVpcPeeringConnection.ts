...
export interface ec2_getNetworkInsightsAnalysisExplanationVpcPeeringConnection {
...
export function ec2_getNetworkInsightsAnalysisExplanationVpcPeeringConnection_GetTypes(): DynamicUIProps[] {
  return [
