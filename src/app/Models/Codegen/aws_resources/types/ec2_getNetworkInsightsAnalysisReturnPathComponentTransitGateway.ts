...
export interface ec2_getNetworkInsightsAnalysisReturnPathComponentTransitGateway {
...
export function ec2_getNetworkInsightsAnalysisReturnPathComponentTransitGateway_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
