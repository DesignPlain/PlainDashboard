...
export interface lex_V2modelsIntentConfirmationSettingFailureNextStepDialogAction {
...
export function lex_V2modelsIntentConfirmationSettingFailureNextStepDialogAction_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Bool,
      "suppressNextMessage",
