...
export interface opsworks_StaticWebLayerLoadBasedAutoScalingDownscaling {
  //
...
export function opsworks_StaticWebLayerLoadBasedAutoScalingDownscaling_GetTypes(): DynamicUIProps[] {
  return [
