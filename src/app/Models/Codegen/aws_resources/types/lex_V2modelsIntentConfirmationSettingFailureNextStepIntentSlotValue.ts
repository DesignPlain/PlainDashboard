...
export interface lex_V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue {
...
export function lex_V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "interpretedValue",
