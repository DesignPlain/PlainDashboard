...
import {
  wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern,
  wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern_GetTypes,
} from "./wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern";

export interface wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody {
  ...
  matchPattern?: wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern;
...
export function wafv2_RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
