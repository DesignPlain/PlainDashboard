...
export interface macie2_ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndSimpleCriterion {
...
export function macie2_ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndSimpleCriterion_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "comparator",
