...
export interface wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchBody {
...
export function wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "oversizeHandling",
