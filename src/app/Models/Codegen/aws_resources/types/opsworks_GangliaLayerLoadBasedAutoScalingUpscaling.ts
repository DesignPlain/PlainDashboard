...
export interface opsworks_GangliaLayerLoadBasedAutoScalingUpscaling {
  //
...
export function opsworks_GangliaLayerLoadBasedAutoScalingUpscaling_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Number,
      "memoryThreshold",
