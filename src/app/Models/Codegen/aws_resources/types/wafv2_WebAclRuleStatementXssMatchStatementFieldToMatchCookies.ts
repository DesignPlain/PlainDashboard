...
import {
  wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern,
...
export interface wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchCookies {
  ...
  matchPatterns?: Array<wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern>;
...
export function wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchCookies_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "matchPatterns",
