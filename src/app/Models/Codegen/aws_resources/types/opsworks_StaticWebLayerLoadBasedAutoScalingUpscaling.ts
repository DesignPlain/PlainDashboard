...
export interface opsworks_StaticWebLayerLoadBasedAutoScalingUpscaling {
  //
...
export function opsworks_StaticWebLayerLoadBasedAutoScalingUpscaling_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Number,
      "memoryThreshold",
