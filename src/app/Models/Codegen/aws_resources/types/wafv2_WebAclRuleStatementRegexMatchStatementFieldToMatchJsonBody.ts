...
import {
  wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern,
  wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern_GetTypes,
} from "./wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern";

export interface wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBody {
  ...
  matchPattern?: wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern;
...
export function wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
