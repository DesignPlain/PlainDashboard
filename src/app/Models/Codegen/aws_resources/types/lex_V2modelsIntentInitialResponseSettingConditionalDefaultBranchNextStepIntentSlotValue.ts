...
export interface lex_V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepIntentSlotValue {
...
export function lex_V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepIntentSlotValue_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "interpretedValue",
