...
export interface ec2_getNetworkInsightsAnalysisForwardPathComponentAdditionalDetailComponent {
...
export function ec2_getNetworkInsightsAnalysisForwardPathComponentAdditionalDetailComponent_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
