...
export interface lex_V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction {
...
export function lex_V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "type",
