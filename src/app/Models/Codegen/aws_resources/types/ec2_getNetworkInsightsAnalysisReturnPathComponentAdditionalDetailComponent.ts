...
export interface ec2_getNetworkInsightsAnalysisReturnPathComponentAdditionalDetailComponent {
...
export function ec2_getNetworkInsightsAnalysisReturnPathComponentAdditionalDetailComponent_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
