...
export interface servicecatalog_ProvisionedProductStackSetProvisioningPreferences {
...
export function servicecatalog_ProvisionedProductStackSetProvisioningPreferences_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "accounts",
