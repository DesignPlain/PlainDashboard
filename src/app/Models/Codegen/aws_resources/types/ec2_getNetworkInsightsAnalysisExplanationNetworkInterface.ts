...
export interface ec2_getNetworkInsightsAnalysisExplanationNetworkInterface {
...
export function ec2_getNetworkInsightsAnalysisExplanationNetworkInterface_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
