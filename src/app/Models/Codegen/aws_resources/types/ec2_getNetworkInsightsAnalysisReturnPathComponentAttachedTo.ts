...
export interface ec2_getNetworkInsightsAnalysisReturnPathComponentAttachedTo {
...
export function ec2_getNetworkInsightsAnalysisReturnPathComponentAttachedTo_GetTypes(): DynamicUIProps[] {
  return [
