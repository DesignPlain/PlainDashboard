...
export interface lex_V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue {
...
export function lex_V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "interpretedValue",
