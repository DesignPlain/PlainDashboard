...
export interface lex_V2modelsIntentClosingSettingNextStepIntentSlotValue {
...
export function lex_V2modelsIntentClosingSettingNextStepIntentSlotValue_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "interpretedValue",
