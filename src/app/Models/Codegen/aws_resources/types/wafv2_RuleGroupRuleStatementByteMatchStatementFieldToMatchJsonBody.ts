...
import {
  wafv2_RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern,
  wafv2_RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern_GetTypes,
...
export interface wafv2_RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody {
  ...
  matchPattern?: wafv2_RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern;
...
export function wafv2_RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
