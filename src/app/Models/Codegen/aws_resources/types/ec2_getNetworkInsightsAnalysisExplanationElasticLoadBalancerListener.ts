...
export interface ec2_getNetworkInsightsAnalysisExplanationElasticLoadBalancerListener {
...
export function ec2_getNetworkInsightsAnalysisExplanationElasticLoadBalancerListener_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
