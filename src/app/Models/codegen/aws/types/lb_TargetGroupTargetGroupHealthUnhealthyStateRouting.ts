...
export interface lb_TargetGroupTargetGroupHealthUnhealthyStateRouting {
...
export function lb_TargetGroupTargetGroupHealthUnhealthyStateRouting_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
