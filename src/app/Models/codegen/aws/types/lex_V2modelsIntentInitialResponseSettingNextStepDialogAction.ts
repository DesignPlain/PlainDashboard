...
export interface lex_V2modelsIntentInitialResponseSettingNextStepDialogAction {
...
export function lex_V2modelsIntentInitialResponseSettingNextStepDialogAction_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "slotToElicit",
