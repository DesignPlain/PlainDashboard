...
import {
  wafv2_WebAclRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern,
  wafv2_WebAclRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern_GetTypes,
} from './wafv2_WebAclRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern';

export interface wafv2_WebAclRuleStatementSqliMatchStatementFieldToMatchJsonBody {
  ...
  matchPattern?: wafv2_WebAclRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern;
...
export function wafv2_WebAclRuleStatementSqliMatchStatementFieldToMatchJsonBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
