...
export interface ec2_getNetworkInsightsAnalysisExplanationTransitGatewayAttachment {
...
export function ec2_getNetworkInsightsAnalysisExplanationTransitGatewayAttachment_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'name',
