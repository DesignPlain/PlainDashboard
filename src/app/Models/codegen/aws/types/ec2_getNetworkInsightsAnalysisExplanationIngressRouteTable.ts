...
export interface ec2_getNetworkInsightsAnalysisExplanationIngressRouteTable {
...
export function ec2_getNetworkInsightsAnalysisExplanationIngressRouteTable_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'name',
