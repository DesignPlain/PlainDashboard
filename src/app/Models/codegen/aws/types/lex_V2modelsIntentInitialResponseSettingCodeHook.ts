...
export interface lex_V2modelsIntentInitialResponseSettingCodeHook {
  ...
  postCodeHookSpecification?: lex_V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecification;
}

export function lex_V2modelsIntentInitialResponseSettingCodeHook_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Object,
