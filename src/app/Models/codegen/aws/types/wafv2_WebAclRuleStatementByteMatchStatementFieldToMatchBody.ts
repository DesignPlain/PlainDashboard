...
export interface wafv2_WebAclRuleStatementByteMatchStatementFieldToMatchBody {
...
export function wafv2_WebAclRuleStatementByteMatchStatementFieldToMatchBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "oversizeHandling",
