...
export interface wafv2_WebAclRuleActionChallengeCustomRequestHandlingInsertHeader {
...
export function wafv2_WebAclRuleActionChallengeCustomRequestHandlingInsertHeader_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
