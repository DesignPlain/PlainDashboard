...
export interface wafv2_WebAclAssociationConfigRequestBodyVerifiedAccessInstance {
...
export function wafv2_WebAclAssociationConfigRequestBodyVerifiedAccessInstance_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
