...
export interface wafv2_WebAclRuleActionAllowCustomRequestHandlingInsertHeader {
...
export function wafv2_WebAclRuleActionAllowCustomRequestHandlingInsertHeader_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "value",
