...
export interface ec2transitgateway_getDirectConnectGatewayAttachmentFilter {
...
export function ec2transitgateway_getDirectConnectGatewayAttachmentFilter_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'name',
