...
import {
  wafv2_WebAclRuleStatementGeoMatchStatementForwardedIpConfig,
  wafv2_WebAclRuleStatementGeoMatchStatementForwardedIpConfig_GetTypes,
} from './wafv2_WebAclRuleStatementGeoMatchStatementForwardedIpConfig';

export interface wafv2_WebAclRuleStatementGeoMatchStatement {
  ...
  forwardedIpConfig?: wafv2_WebAclRuleStatementGeoMatchStatementForwardedIpConfig;
}

export function wafv2_WebAclRuleStatementGeoMatchStatement_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      'countryCodes',
