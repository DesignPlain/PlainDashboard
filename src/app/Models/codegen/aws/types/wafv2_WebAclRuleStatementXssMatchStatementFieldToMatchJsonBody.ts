...
import {
  wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern,
...
export interface wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody {
  ...
  matchPattern?: wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern;

  // The parts of the JSON to match against using the `match_pattern`. Valid values are `ALL`, `KEY` and `VALUE`.
  matchScope?: string;
}

export function wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
