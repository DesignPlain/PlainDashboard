...
export interface ec2_getNetworkInsightsAnalysisExplanationComponent {
...
export function ec2_getNetworkInsightsAnalysisExplanationComponent_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'arn',
