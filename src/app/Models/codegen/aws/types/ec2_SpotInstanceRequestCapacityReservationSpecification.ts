...
*/
  capacityReservationTarget?: ec2_SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTarget;
}

export function ec2_SpotInstanceRequestCapacityReservationSpecification_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
