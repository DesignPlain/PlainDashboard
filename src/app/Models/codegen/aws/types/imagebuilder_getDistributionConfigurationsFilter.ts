...
export interface imagebuilder_getDistributionConfigurationsFilter {
...
export function imagebuilder_getDistributionConfigurationsFilter_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
