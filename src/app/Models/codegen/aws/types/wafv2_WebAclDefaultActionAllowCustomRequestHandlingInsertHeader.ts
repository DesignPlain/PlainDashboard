...
export interface wafv2_WebAclDefaultActionAllowCustomRequestHandlingInsertHeader {
...
export function wafv2_WebAclDefaultActionAllowCustomRequestHandlingInsertHeader_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
