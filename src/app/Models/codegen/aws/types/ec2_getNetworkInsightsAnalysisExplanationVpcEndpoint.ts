...
export interface ec2_getNetworkInsightsAnalysisExplanationVpcEndpoint {
...
export function ec2_getNetworkInsightsAnalysisExplanationVpcEndpoint_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
