...
export interface ec2_getNetworkInsightsAnalysisExplanationPrefixList {
  //
  id?: string;
...
export function ec2_getNetworkInsightsAnalysisExplanationPrefixList_GetTypes(): DynamicUIProps[] {
  return [
