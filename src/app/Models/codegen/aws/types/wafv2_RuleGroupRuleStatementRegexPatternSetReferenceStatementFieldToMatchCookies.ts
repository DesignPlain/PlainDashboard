...
import {
  wafv2_RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPattern,
  wafv2_RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPattern_GetTypes,
} from './wafv2_RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPattern';

export interface wafv2_RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies {
  ...
  matchPatterns?: Array<wafv2_RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPattern>;
...
export function wafv2_RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'matchScope',
