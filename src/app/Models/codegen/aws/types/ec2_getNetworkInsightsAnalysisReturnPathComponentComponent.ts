...
export interface ec2_getNetworkInsightsAnalysisReturnPathComponentComponent {
  //
  id?: string;
...
export function ec2_getNetworkInsightsAnalysisReturnPathComponentComponent_GetTypes(): DynamicUIProps[] {
  return [
