...
export interface wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchBody {
...
export function wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'oversizeHandling',
