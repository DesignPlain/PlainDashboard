...
export interface wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern {
  ...
  all?: wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternAll;
...
export function wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "includedHeaders",
