...
export interface ec2_getNetworkInsightsAnalysisExplanationInternetGateway {
...
export function ec2_getNetworkInsightsAnalysisExplanationInternetGateway_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
