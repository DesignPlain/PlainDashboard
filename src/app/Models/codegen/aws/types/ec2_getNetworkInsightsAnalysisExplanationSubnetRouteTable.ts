...
export interface ec2_getNetworkInsightsAnalysisExplanationSubnetRouteTable {
...
export function ec2_getNetworkInsightsAnalysisExplanationSubnetRouteTable_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
