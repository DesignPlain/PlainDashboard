...
export interface wafv2_WebAclRuleStatementSqliMatchStatementFieldToMatchBody {
...
export function wafv2_WebAclRuleStatementSqliMatchStatementFieldToMatchBody_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "oversizeHandling",
