...
export interface networkfirewall_FirewallEncryptionConfiguration {
...
export function networkfirewall_FirewallEncryptionConfiguration_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "type",
