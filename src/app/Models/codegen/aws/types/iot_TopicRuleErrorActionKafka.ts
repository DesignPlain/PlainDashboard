...
import {
  iot_TopicRuleErrorActionKafkaHeader,
  iot_TopicRuleErrorActionKafkaHeader_GetTypes,
} from "./iot_TopicRuleErrorActionKafkaHeader";

export interface iot_TopicRuleErrorActionKafka {
  ...
  headers?: Array<iot_TopicRuleErrorActionKafkaHeader>;
...
export function iot_TopicRuleErrorActionKafka_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Map,
      "clientProperties",
