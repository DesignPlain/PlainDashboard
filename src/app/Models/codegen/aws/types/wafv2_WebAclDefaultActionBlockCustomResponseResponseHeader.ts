...
export interface wafv2_WebAclDefaultActionBlockCustomResponseResponseHeader {
...
export function wafv2_WebAclDefaultActionBlockCustomResponseResponseHeader_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
