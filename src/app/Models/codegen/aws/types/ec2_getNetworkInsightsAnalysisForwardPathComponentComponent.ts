...
export interface ec2_getNetworkInsightsAnalysisForwardPathComponentComponent {
...
export function ec2_getNetworkInsightsAnalysisForwardPathComponentComponent_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
