...
export interface ec2_getNetworkInsightsAnalysisExplanationSecurityGroup {
...
export function ec2_getNetworkInsightsAnalysisExplanationSecurityGroup_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
