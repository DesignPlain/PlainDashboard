...
export interface lex_V2modelsIntentClosingSettingConditionalConditionalBranch {
  ...
  condition?: lex_V2modelsIntentClosingSettingConditionalConditionalBranchCondition;

  // Name of the branch.
  name?: string;

  // Configuration block for the next step in the conversation. See `next_step`.
  nextStep?: lex_V2modelsIntentClosingSettingConditionalConditionalBranchNextStep;

  // Configuration block for a list of message groups that Amazon Lex uses to respond to the user input. See `response`.
  response?: lex_V2modelsIntentClosingSettingConditionalConditionalBranchResponse;
}

export function lex_V2modelsIntentClosingSettingConditionalConditionalBranch_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Object,
      "condition",
