...
export interface ec2_getNetworkInsightsAnalysisForwardPathComponentTransitGateway {
...
export function ec2_getNetworkInsightsAnalysisForwardPathComponentTransitGateway_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
