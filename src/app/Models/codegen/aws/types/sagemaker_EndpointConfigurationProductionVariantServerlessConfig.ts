...
export interface sagemaker_EndpointConfigurationProductionVariantServerlessConfig {
...
export function sagemaker_EndpointConfigurationProductionVariantServerlessConfig_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Number,
      "memorySizeInMb",
