...
export interface wafv2_WebAclRuleActionBlockCustomResponseResponseHeader {
...
export function wafv2_WebAclRuleActionBlockCustomResponseResponseHeader_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
