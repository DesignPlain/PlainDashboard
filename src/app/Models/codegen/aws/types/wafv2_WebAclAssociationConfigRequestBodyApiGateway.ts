...
export interface wafv2_WebAclAssociationConfigRequestBodyApiGateway {
...
export function wafv2_WebAclAssociationConfigRequestBodyApiGateway_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
