...
export interface wafv2_WebAclRuleActionCountCustomRequestHandlingInsertHeader {
...
export function wafv2_WebAclRuleActionCountCustomRequestHandlingInsertHeader_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "name",
