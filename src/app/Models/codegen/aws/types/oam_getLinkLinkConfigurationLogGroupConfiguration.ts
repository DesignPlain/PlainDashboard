...
export interface oam_getLinkLinkConfigurationLogGroupConfiguration {
...
export function oam_getLinkLinkConfigurationLogGroupConfiguration_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'filter',
