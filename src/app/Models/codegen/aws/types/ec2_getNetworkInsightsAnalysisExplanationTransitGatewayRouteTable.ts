...
export interface ec2_getNetworkInsightsAnalysisExplanationTransitGatewayRouteTable {
...
export function ec2_getNetworkInsightsAnalysisExplanationTransitGatewayRouteTable_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
