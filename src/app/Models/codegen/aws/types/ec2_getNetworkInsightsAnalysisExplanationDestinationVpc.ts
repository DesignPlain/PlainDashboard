...
export interface ec2_getNetworkInsightsAnalysisExplanationDestinationVpc {
...
export function ec2_getNetworkInsightsAnalysisExplanationDestinationVpc_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
