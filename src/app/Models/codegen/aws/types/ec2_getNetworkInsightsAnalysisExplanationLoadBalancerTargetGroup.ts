...
export interface ec2_getNetworkInsightsAnalysisExplanationLoadBalancerTargetGroup {
...
export function ec2_getNetworkInsightsAnalysisExplanationLoadBalancerTargetGroup_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
