...
export interface codepipeline_PipelineTriggerGitConfigurationPushFilePaths {
...
export function codepipeline_PipelineTriggerGitConfigurationPushFilePaths_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      "includes",
