...
export interface ec2_getNetworkInsightsAnalysisForwardPathComponentSourceVpc {
...
export function ec2_getNetworkInsightsAnalysisForwardPathComponentSourceVpc_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
