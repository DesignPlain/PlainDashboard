...
export interface ec2_getNetworkInsightsAnalysisForwardPathComponentSubnet {
...
export function ec2_getNetworkInsightsAnalysisForwardPathComponentSubnet_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
