...
export interface lex_V2modelsIntentClosingSettingNextStepDialogAction {
...
export function lex_V2modelsIntentClosingSettingNextStepDialogAction_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "slotToElicit",
