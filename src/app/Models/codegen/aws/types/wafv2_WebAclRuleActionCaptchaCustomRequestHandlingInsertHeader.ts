...
export interface wafv2_WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader {
...
export function wafv2_WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'name',
