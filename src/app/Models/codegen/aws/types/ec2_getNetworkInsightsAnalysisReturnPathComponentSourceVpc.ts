...
export interface ec2_getNetworkInsightsAnalysisReturnPathComponentSourceVpc {
...
export function ec2_getNetworkInsightsAnalysisReturnPathComponentSourceVpc_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
