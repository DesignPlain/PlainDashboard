...
export interface ec2_getNetworkInsightsAnalysisExplanationSubnet {
...
export function ec2_getNetworkInsightsAnalysisExplanationSubnet_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
