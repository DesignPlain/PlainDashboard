...
import {
  wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern,
  wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern_GetTypes,
} from "./wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern";

export interface wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchCookies {
  ...
  matchPatterns?: Array<wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern>;
...
export function wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchCookies_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "oversizeHandling",
