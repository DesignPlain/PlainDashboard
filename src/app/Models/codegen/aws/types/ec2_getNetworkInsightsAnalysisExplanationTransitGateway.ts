...
export interface ec2_getNetworkInsightsAnalysisExplanationTransitGateway {
...
export function ec2_getNetworkInsightsAnalysisExplanationTransitGateway_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "arn",
