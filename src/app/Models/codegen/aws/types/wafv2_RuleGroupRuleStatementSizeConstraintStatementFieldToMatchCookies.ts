...
import {
  wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern,
  wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern_GetTypes,
} from './wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern';

export interface wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies {
  ...
  matchPatterns?: Array<wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern>;
...
export function wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'oversizeHandling',
