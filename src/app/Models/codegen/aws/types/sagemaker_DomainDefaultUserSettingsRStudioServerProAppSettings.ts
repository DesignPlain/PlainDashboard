...
export interface sagemaker_DomainDefaultUserSettingsRStudioServerProAppSettings {
...
export function sagemaker_DomainDefaultUserSettingsRStudioServerProAppSettings_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'accessStatus',
