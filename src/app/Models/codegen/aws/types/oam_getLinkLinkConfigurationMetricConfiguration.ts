...
export interface oam_getLinkLinkConfigurationMetricConfiguration {
...
export function oam_getLinkLinkConfigurationMetricConfiguration_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "filter",
