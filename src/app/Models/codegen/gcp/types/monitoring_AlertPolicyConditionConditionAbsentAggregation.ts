...
export interface monitoring_AlertPolicyConditionConditionAbsentAggregation {
  /*
...
export function monitoring_AlertPolicyConditionConditionAbsentAggregation_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      "alignmentPeriod",
