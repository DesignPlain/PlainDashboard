...
export interface compute_InstanceNetworkInterfaceIpv6AccessConfig {
  /*
...
export function compute_InstanceNetworkInterfaceIpv6AccessConfig_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'networkTier',
