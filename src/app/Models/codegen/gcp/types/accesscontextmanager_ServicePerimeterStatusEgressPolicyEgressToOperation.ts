...
*/
  methodSelectors?: Array<accesscontextmanager_ServicePerimeterStatusEgressPolicyEgressToOperationMethodSelector>;
...
export function accesscontextmanager_ServicePerimeterStatusEgressPolicyEgressToOperation_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.Array,
      'methodSelectors',
