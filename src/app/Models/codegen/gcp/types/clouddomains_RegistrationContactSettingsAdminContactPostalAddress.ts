...
export interface clouddomains_RegistrationContactSettingsAdminContactPostalAddress {
  /*
...
export function clouddomains_RegistrationContactSettingsAdminContactPostalAddress_GetTypes(): DynamicUIProps[] {
  return [
    new DynamicUIProps(
      InputType.String,
      'locality',
