...
import {
  cloudbuildv2_ConnectionIAMMemberCondition,
  cloudbuildv2_ConnectionIAMMemberCondition_GetTypes,
} from '../types/cloudbuildv2_ConnectionIAMMemberCondition';

export interface ConnectionIAMMemberArgs {
  //
  condition?: cloudbuildv2_ConnectionIAMMemberCondition;
...
export class ConnectionIAMMember extends DS_Resource {
  //
  public condition?: cloudbuildv2_ConnectionIAMMemberCondition;
