...
export class CloudResource {
  ...
  public inletMap: Map<number, lineCoordinates> = new Map<number, {x:number, y:number, x2:number, y2: number}>();
  public inletMapString: string;
  public outletMapString: string;
  public outletMap: Map<number, lineCoordinates> = new Map<number, {x:number, y:number, x2:number, y2: number}>();
}
